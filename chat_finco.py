...
Las respuestas deben claras y cortas, no exceder las 100 palabras
'''


st.title("Chat con EVAL - IA 💬🧑‍💻")
...
def generate_response(model):
    history = [st.session_state.messages[0]] if len(st.session_state.messages)>5 else st.session_state.messages
